...
async function getSoapService(service, wsdl, endpoint) {
    ...
    const options = {
        forceSoap12Headers: true // Ensure SOAP 1.2 headers
    };
    ...
    //return soap.createClient(wsdl, { httpClient: httpClient });
    return soap.createClientAsync(wsdl, { httpClient: httpClient, ...options });
}
