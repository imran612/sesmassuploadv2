/* checksum : 9b979547313c36d7bc331f1891e74b12 */
@cds.external : true
...
entity ZAPI_PURCHASEORDER_PROCESS_SRV.A_POSubcontractingComponent {
...
entity ZAPI_PURCHASEORDER_PROCESS_SRV.A_PurchaseOrder {
  ...
  to_PurchaseOrderItem : Composition of many ZAPI_PURCHASEORDER_PROCESS_SRV.A_PurchaseOrderItem on to_PurchaseOrderItem.PurchaseOrder = PurchaseOrder;
  @cds.ambiguous : 'missing on condition?'
  to_PurchaseOrderNote : Composition of many ZAPI_PURCHASEORDER_PROCESS_SRV.A_PurchaseOrderNote on to_PurchaseOrderNote.PurchaseOrder = PurchaseOrder;
};
...
entity ZAPI_PURCHASEORDER_PROCESS_SRV.A_PurchaseOrderItem {
  ...
  @cds.ambiguous : 'missing on condition?'
  to_PurchaseOrder : Association to ZAPI_PURCHASEORDER_PROCESS_SRV.A_PurchaseOrder on to_PurchaseOrder.PurchaseOrder = PurchaseOrder;
  @cds.ambiguous : 'missing on condition?'
  to_AccountAssignment : Composition of many ZAPI_PURCHASEORDER_PROCESS_SRV.A_PurOrdAccountAssignment on to_AccountAssignment.PurchaseOrderItem = PurchaseOrderItem and to_AccountAssignment.PurchaseOrder = PurchaseOrder;
  @cds.ambiguous : 'missing on condition?'
  to_PurchaseOrderItemNote : Composition of many ZAPI_PURCHASEORDER_PROCESS_SRV.A_PurchaseOrderItemNote on to_PurchaseOrderItemNote.PurchaseOrderItem = PurchaseOrderItem and to_PurchaseOrderItemNote.PurchaseOrder = PurchaseOrder;
  @cds.ambiguous : 'missing on condition?'
  to_PurchaseOrderPricingElement : Composition of many ZAPI_PURCHASEORDER_PROCESS_SRV.A_PurOrdPricingElement on to_PurchaseOrderPricingElement.PurchaseOrderItem = PurchaseOrderItem and to_PurchaseOrderPricingElement.PurchaseOrder = PurchaseOrder;
  @cds.ambiguous : 'missing on condition?'
  to_ScheduleLine : Composition of many ZAPI_PURCHASEORDER_PROCESS_SRV.A_PurchaseOrderScheduleLine on to_ScheduleLine.PurchasingDocumentItem = PurchaseOrderItem and to_ScheduleLine.PurchasingDocument = PurchaseOrder;
};
...
entity ZAPI_PURCHASEORDER_PROCESS_SRV.A_PurchaseOrderItemNote {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Purchasing Document'
...
entity ZAPI_PURCHASEORDER_PROCESS_SRV.A_PurchaseOrderNote {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Purchasing Document'
  @sap.quickinfo : 'Purchasing Document Number'
  key PurchaseOrder : String(10) not null;
...
entity ZAPI_PURCHASEORDER_PROCESS_SRV.A_PurchaseOrderScheduleLine {
  ...
  @cds.ambiguous : 'missing on condition?'
  to_SubcontractingComponent : Composition of many ZAPI_PURCHASEORDER_PROCESS_SRV.A_POSubcontractingComponent on to_SubcontractingComponent.ScheduleLine = ScheduleLine and to_SubcontractingComponent.PurchaseOrderItem = PurchasingDocumentItem and to_SubcontractingComponent.PurchaseOrder = PurchasingDocument;
};
